...
In Appendix \ref{sec:appendixErlangRoutingState} on page \pageref{sec:appendixErlangRoutingState} I show how I translated the Chord and Pastry routing state into Erlang records.
...
%   How is routing done?
The routing algorithms for both Chord and Pastry are reasonably compact. I will try to give an intuition for how the routing works before showing you pseudo-code from the Chord \cite{chord} and Pastry \cite{pastry} papers before showing you the corresponding Erlang implementations.
